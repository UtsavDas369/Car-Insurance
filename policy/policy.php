<html>    
    ...
    <body>    
		...
		<h3 style="text-align: center;  ">Policy Form</h3>    

        <form name = "form1" action='input.php' method = 'POST' enctype = "multipart/form-data" style="color: white;
	margin-top: 20px;
 ...
 >    
            <div  class = "container">
				...
				<div class = "form_group">    
                    <label>Enter 9 digit Policy Number:</label>    
                ...
                <div class = "form_group">    
                    <label>Fine:</label>    
                    <input type = "text" name = "Fine" value = "" required />    
                </div>    
                <div class = "form_group">    
                    <label>Lateness</label>    
                    <input type = "text" name = "Lateness" value = "" required />    
                </div>  
