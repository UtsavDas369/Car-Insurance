         ...
         <form name = "form1" action='input.php' method = 'POST' enctype = "multipart/form-data" >    
            <div class = "container">
				...
				<div class = "form_group">    
                    ...
                    <input type = "radio" name = "Mother_Status" value = "Alive" required />Alive	    <input type = "radio" name = "Mother_Status" value = "D" required />Dead    
                </div>
				<div class = "form_group">    
				...
				<div class = "form_group">    
                    ...
                    <input type = "radio" name = "Father_Status" value = "Alive" required />Alive	    <input type = "radio" name = "Father_Status" value = "D" required/>Dead    
                </div>
				<div class = "form_group">    
                    <label>Marital Status: </label>    
                    <input type = "radio" name = "Marital_Status" value = "Single" required />Single	    <input type = "radio" name = "Marital_Status" value = "Married" required/>Married    
                </div>
				<div class = "form_group">    
                ...
                <div class = "form_group">    
                    <label>Choose Plan:  </label><input type = "radio" name = "Plan" value = "7000" required />Normal<input type = "radio" name = "Plan" value = "15000" required />Premium<input type = "radio" name = "Plan" value = "45000" required />Sports 
                </div>
